...
#  类名
#class_names = ['Biscuits', 'Chips', 'Water', 'Green tea', 'Herbal tea', 'Lemon tea', 'Milk tea', 'Cookies', 'Pepsi', 'Coca Cola', 'Sprite', 'Dish soap', 'Bath cream', 'Shampoo', 'Toothpaste', 'Toy', 'Beer', 'Fruit', 'Paper', 'Plant']
class_names = ['Dish soap']
#  转换一个xml文件为txt
...
def dir_xml_to_txt(path):
    ...
    for xml_file in glob.glob(path + '*.xml'):
        print("processing {}, {}".format(i, xml_file))
